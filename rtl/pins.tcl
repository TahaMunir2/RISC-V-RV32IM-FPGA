...
# Set IO Standard for all SEGMENT pins
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SEGMENT0[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SEGMENT1[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SEGMENT2[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SEGMENT3[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SEGMENT4[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to SEGMENT5[0]
