...
Each time we are saving csr[340] into x1, so we can trace the waveforms to check it's actually changing correctly (note: t1 = reg[5], t2 = reg[6], t3 = reg[28]) as shown below:
