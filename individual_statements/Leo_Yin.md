...
I also wrote the full documentation of the cache section, which goes into much more detail about how the cache works. The file can be found here: [Cache README](https://github.com/TahaMunir2/RISC-V-RV32IM-FPGA/blob/Hierarchical-cache/README.md)
