...
In this lab, we were able to create the basic components of the CPU, and combine them all together in a top level module, with the hierarchy specified in the image below:
...
# Challenge
As a challenge, we decided to implement RAM alongside our already existing ROM, and the load word instruction to our design.
