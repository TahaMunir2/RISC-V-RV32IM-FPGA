...
- [Implementation](#implementation)
  ...
  - [FPGA](#fpga-1)
    ...
    - [Debouncer](#debouncer)
    - [FPGA Wrapper](#fpga-wrapper)
    - [Pins](#pins)
- [Schematics](#3-schematics)
- [Testing](#4-testing)
  - [Interrupts and Simulation](#interrupts-and-simulation)
    - [External Interupts](#external-interupts)
    - [Timer Interupts](#timer-interupts)
  - [FPGA](#fpga-2)
    - [LEDs and 7-Segment Displays Test](#leds-and-7-segment-displays-test)
    - [External Interrupt Test](#external-interrupt-test)
    - [Timer Interrupt Test](#timer-interrupt-test)
