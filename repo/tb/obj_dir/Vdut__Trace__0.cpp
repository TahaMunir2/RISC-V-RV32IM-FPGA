...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+30,(vlSelf->data_out),32);
    bufp->chgWData(oldp+31,(vlSelf->write_back),128);
    bufp->chgBit(oldp+35,(vlSelf->write_back_en));
    bufp->chgBit(oldp+36,(vlSelf->stall));
    bufp->chgIData(oldp+37,((vlSelf->addr >> 0xbU)),21);
    bufp->chgCData(oldp+38,((0x7fU & (vlSelf->addr 
                                      >> 4U))),7);
    bufp->chgCData(oldp+39,((3U & (vlSelf->addr >> 2U))),2);
    bufp->chgCData(oldp+40,((3U & vlSelf->addr)),2);
}
