...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+37,(vlSelf->write_back_addr),32);
    bufp->chgIData(oldp+38,(vlSelf->l2_addr),32);
    bufp->chgBit(oldp+39,(vlSelf->l2_fetch));
    bufp->chgBit(oldp+40,(vlSelf->stall));
    bufp->chgIData(oldp+41,((vlSelf->addr >> 0xbU)),21);
    bufp->chgCData(oldp+42,((0x7fU & (vlSelf->addr 
                                      >> 4U))),7);
    bufp->chgCData(oldp+43,((3U & (vlSelf->addr >> 2U))),2);
    bufp->chgCData(oldp+44,((3U & vlSelf->addr)),2);
}
