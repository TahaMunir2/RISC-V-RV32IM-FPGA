...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+31,"wake", false,-1);
    ...
    tracep->declBus(c+39,"tag_bits", false,-1, 31,11);
    tracep->declBus(c+40,"set", false,-1, 6,0);
    tracep->declBus(c+41,"block_offset", false,-1, 1,0);
    tracep->declBus(c+42,"byte_offset", false,-1, 1,0);
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+31,(vlSelf->wake));
    ...
    bufp->fullBit(oldp+38,(vlSelf->stall));
    bufp->fullIData(oldp+39,((vlSelf->addr >> 0xbU)),21);
    bufp->fullCData(oldp+40,((0x7fU & (vlSelf->addr 
                                       >> 4U))),7);
    bufp->fullCData(oldp+41,((3U & (vlSelf->addr >> 2U))),2);
    bufp->fullCData(oldp+42,((3U & vlSelf->addr)),2);
