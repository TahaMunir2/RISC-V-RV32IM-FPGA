...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+32,"data_out", false,-1, 31,0);
    tracep->declArray(c+33,"write_back", false,-1, 127,0);
    tracep->declBit(c+37,"write_back_en", false,-1);
    tracep->declBus(c+38,"write_back_addr", false,-1, 31,0);
    tracep->declBus(c+39,"l2_addr", false,-1, 31,0);
    tracep->declBit(c+40,"l2_fetch", false,-1);
    tracep->declBit(c+41,"stall", false,-1);
    tracep->pushNamePrefix("l1d_cache ");
    tracep->declBus(c+46,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+46,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+47,"BLOCK_SIZE", false,-1, 31,0);
    tracep->declBit(c+19,"clk", false,-1);
    tracep->declBit(c+20,"fetch", false,-1);
    tracep->declBus(c+21,"addr", false,-1, 31,0);
    tracep->declBus(c+22,"wd", false,-1, 31,0);
    ...
    tracep->declBus(c+42,"tag_bits", false,-1, 31,11);
    tracep->declBus(c+43,"set", false,-1, 6,0);
    tracep->declBus(c+44,"block_offset", false,-1, 1,0);
    tracep->declBus(c+45,"byte_offset", false,-1, 1,0);
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+32,(vlSelf->data_out),32);
    bufp->fullWData(oldp+33,(vlSelf->write_back),128);
    bufp->fullBit(oldp+37,(vlSelf->write_back_en));
    bufp->fullIData(oldp+38,(vlSelf->write_back_addr),32);
    bufp->fullIData(oldp+39,(vlSelf->l2_addr),32);
    bufp->fullBit(oldp+40,(vlSelf->l2_fetch));
    bufp->fullBit(oldp+41,(vlSelf->stall));
    bufp->fullIData(oldp+42,((vlSelf->addr >> 0xbU)),21);
    bufp->fullCData(oldp+43,((0x7fU & (vlSelf->addr 
                                       >> 4U))),7);
    bufp->fullCData(oldp+44,((3U & (vlSelf->addr >> 2U))),2);
    bufp->fullCData(oldp+45,((3U & vlSelf->addr)),2);
