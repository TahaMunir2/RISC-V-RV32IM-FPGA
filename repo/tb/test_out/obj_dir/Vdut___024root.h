...
class Vdut___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ l2_cache__DOT__clean;
        CData/*1:0*/ l2_cache__DOT__way_rd;
        CData/*7:0*/ l2_cache__DOT__set_rd;
        CData/*2:0*/ l2_cache__DOT__block_offset_rd;
        ...
        CData/*0:0*/ l2_cache__DOT__wb_ready_d_next;
        CData/*0:0*/ l2_cache__DOT__write_back_en_next;
        CData/*0:0*/ l2_cache__DOT__l1write_buffer;
        CData/*0:0*/ l2_cache__DOT__l1write_buffer_next;
        ...
        CData/*1:0*/ l2_cache__DOT__l2write_buffer_next;
    ...
    struct {
        ...
        IData/*31:0*/ l2_cache__DOT__l2write_back_addr_buffer_next;
        IData/*31:0*/ l2_cache__DOT__unnamedblk1__DOT__i;
        IData/*31:0*/ __Vchglast__TOP__l2_cache__DOT__addr;
