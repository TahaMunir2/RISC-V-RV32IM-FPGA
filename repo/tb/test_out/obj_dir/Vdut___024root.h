...
class Vdut___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ l1i_cache__DOT__way;
    CData/*0:0*/ l1i_cache__DOT__hit0;
    CData/*0:0*/ l1i_cache__DOT__hit1;
    CData/*0:0*/ l1i_cache__DOT__valid0;
    CData/*0:0*/ l1i_cache__DOT__valid1;
    CData/*0:0*/ l1i_cache__DOT__miss;
    CData/*6:0*/ l1i_cache__DOT__bottom_bit;
    ...
    VlUnpacked<VlWide<10>/*300:0*/, 128> l1i_cache__DOT__cache;
    VlUnpacked<VlWide<10>/*300:0*/, 128> __Vchglast__TOP__l1i_cache__DOT__cache;
